...
![01-intro-deploy](./images/01-intro-deploy.png)
...
4. **Deploy to the Cloud**: Finally, deploy the Docker container to a cloud service like AWS (AWS Elastic Beanstalk) to make the model accessible globally, ensuring scalability and reliability.
